...
void main(){
  ...
  vec3 lowSunScatter=mix(vec3(1.0,0.3,0.055),transmittedSun,0.42);
  ...
  sky+=transmittedSun*((sunGlow+forwardHalo+innerHalo)*(1.0-uSolarEclipse*0.93)+visibleSunDisc*(3.15+uSunGlow*1.15));
  sky+=transmittedSun*(aerialAureole+horizon*uTwilightFactor*(0.006+twilightSunward*0.055));
...
export class SkyPass {
  constructor(gl) {
    ...
    for (const name of [
      ...
      'uZenithColor','uHorizonColor','uGroundColor','uDayFactor','uNightFactor','uTwilightFactor','uSunVisibility','uRayleigh','uMie','uMieAnisotropy','uOzone','uDust','uAerialPerspective','uHaze','uHumidity','uWeatherFog','uDayFogMultiplier','uNightFogMultiplier',

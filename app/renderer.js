...
export class Renderer3D{
  ...
  render(scene,camera,selectedId,options={}){
    ...
    if(this.skyPass){if(this.skyPass){try{this.skyPass.render(camera,environment);}catch(error){window.__omniforgeDiagnostics?.warn?.('sky-pass-failed',{message:error.message});}}}

...
export const PULSE_BENCHMARK_OBJECT_SPECS = Object.freeze([
  ...
  box('pulse-entry-header','Entry Header',[0,7,14],[6,.7,2.2],'#6d7883',{roughness:.8}),

  box('pulse-occlusion-left','Black Occlusion Wall L',[-8,3.2,4],[12,.45,6.4],'#11151b',{roughness:.98}),
  box('pulse-occlusion-right','Black Occlusion Wall R',[8,3.2,4],[12,.45,6.4],'#11151b',{roughness:.98}),
  box('pulse-occlusion-header','Black Occlusion Header',[0,7,4],[4,.45,2],'#161a20',{roughness:.96}),

  box('pulse-red-wall','Red Bounce Wall',[-13.5,3,-8],[.45,12,6],'#7f2026',{roughness:.9}),
  box('pulse-blue-wall','Blue Bounce Wall',[13.5,3,-8],[.45,12,6],'#1e3e79',{roughness:.9}),
  box('pulse-neutral-back','Neutral Receiver Wall',[0,3,-15],[26,.45,6],'#c4c7c9',{roughness:.92}),

  box('pulse-center-divider','Thin Divider',[0,3,-8],[.22,13,6],'#252b32',{roughness:.96}),
  box('pulse-divider-cap','Divider Cap',[0,6.4,-8],[3.4,.24,.5],'#4a535d',{roughness:.78,metallic:.1}),

  box('pulse-left-ceiling','Left Canopy',[-9,7,-3],[15,14,.45],'#5d666d',{roughness:.82}),
  box('pulse-right-ceiling','Right Canopy',[9,7,-3],[15,14,.45],'#5a636d',{roughness:.82}),
  ...
  box('pulse-island-white','White Bounce Pedestal',[-5,1,-2],[4,4,2],'#dedbd1',{roughness:.7}),
  box('pulse-island-dark','Dark Receiver Pedestal',[5,1,-2],[4,4,2],'#11151a',{roughness:.95}),
  box('pulse-metal-monolith','Metal Monolith',[0,2.2,-20],[3,1.6,4.4],'#59636c',{roughness:.18,metallic:.82}),

  box('pulse-step-1','Gallery Step 1',[-7,.2,-20],[5,4,.4],'#6b7278',{roughness:.9}),
  box('pulse-step-2','Gallery Step 2',[-7,.45,-21.2],[5,4,.5],'#737a80',{roughness:.9}),
  box('pulse-step-3','Gallery Step 3',[-7,.7,-22.5],[5,4,.6],'#7b8287',{roughness:.9}),
  box('pulse-step-4','Gallery Step 4',[-7,.95,-23.8],[5,4,.7],'#848b90',{roughness:.9}),

  box('pulse-color-panel-red','Red Test Panel',[-6,2.4,-14.5],[4,.18,4.8],'#9d282d',{roughness:.88}),
  box('pulse-color-panel-blue','Blue Test Panel',[6,2.4,-14.5],[4,.18,4.8],'#244f9a',{roughness:.88}),
  box('pulse-color-panel-green','Green Test Panel',[0,2.4,-28.4],[4,.18,4.8],'#2d754c',{roughness:.88}),
